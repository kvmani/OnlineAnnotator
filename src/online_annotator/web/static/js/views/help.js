...
const SECTIONS = [
  ...
  },
  {
    ...
    body: () => [
      ...
      h("h3", {}, "Starting from model predictions"),
      P("Images tab → Import masks. Name masks after their images (", h("code", {}, "x_mask.png"), "). Binary, red, indexed and class-colour masks are understood. They become the working copy, so annotators only fix mistakes: this is the active-learning loop."),
