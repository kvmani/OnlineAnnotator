-- Database written by Online Annotator v1.1.1 (schema 2), generated with that tag's own
...
CREATE TABLE images (
	...
	mask_source VARCHAR(20) NOT NULL, 
	mask_source_tool VARCHAR(200) NOT NULL, 
	mask_source_remarks TEXT NOT NULL, 
	mask_source_file VARCHAR(255) NOT NULL, 
	mask_imported_by VARCHAR(255), 
...
INSERT INTO "versions" VALUES(1,1,1,'v0001.png','1111111111111111111111111111111111111111111111111111111111111111','{"1": 180}','submission','approved','anil@lab.test','2026-09-01 09:30:00.000000','','rita@lab.test','2026-09-01 09:30:00.000000','','manual','','','');
